...
input_file = base_dir / "FS_var_dist_clutter_both_ends/scripts/FS_1.yaml"
output_dir = base_dir / "FS_var_dist_clutter_both_ends/input"
...
for dista in [-2600, -6600, -11600, -16600, -21600]:
    for link_type in ["dl", "ul"]:
        ...
        modified_text[23] = f"    output_dir: campaigns/FS_var_dist_clutter_both_ends/output"
        modified_text[26] = f"    output_dir_prefix: output_imt_macro_FS_var_dist_clutter_both_ends_{link_type}_{dista}m\n"
