from sharc.run_multiple_campaigns_mut_thread import run_campaign, run_campaign_re
...
run_campaign_re(name_campaign, r'^parameters_imt_ntn_to_imt_tn_no_overlap_bessel_alt_500km_sep_.*km.yaml')
