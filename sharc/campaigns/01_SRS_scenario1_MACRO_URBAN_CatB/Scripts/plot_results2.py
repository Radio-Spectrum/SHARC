...
post_processor\
    .add_plot_legend_pattern(
        dir_name_contains="output_01_SRS_scenario1_MACRO_URBAN_dl_-2600m",
        legend= "DL - D = 1km"
    ).add_plot_legend_pattern(
        dir_name_contains="output_01_SRS_scenario1_MACRO_URBAN_dl_-6600m",
        legend= "DL - D = 5km"
    ).add_plot_legend_pattern(
        dir_name_contains="output_01_SRS_scenario1_MACRO_URBAN_dl_-11600m",
        legend="DL - D = 10km"
    ).add_plot_legend_pattern(
        dir_name_contains="output_01_SRS_scenario1_MACRO_URBAN_dl_-16600m",
        legend="DL - D = 15km"
    ).add_plot_legend_pattern(
        dir_name_contains="output_01_SRS_scenario1_MACRO_URBAN_dl_-21600m",
        legend="DL - D = 20km"
    ).add_plot_legend_pattern(
        dir_name_contains="output_01_SRS_scenario1_MACRO_URBAN_ul_-2600m",
        legend= "UL - D = 1km"
    ).add_plot_legend_pattern(
        dir_name_contains="output_01_SRS_scenario1_MACRO_URBAN_ul_-6600m",
        legend= "UL - D = 6km"
    ).add_plot_legend_pattern(
        dir_name_contains="output_01_SRS_scenario1_MACRO_URBAN_ul_-11600m",
        legend="UL - D = 10km"
    ).add_plot_legend_pattern(
        dir_name_contains="output_01_SRS_scenario1_MACRO_URBAN_ul_-16600m",
        legend="UL - D = 15km"
    ).add_plot_legend_pattern(
        dir_name_contains="output_01_SRS_scenario1_MACRO_URBAN_ul_-21600m",
        legend="UL - D = 20km"
    )
