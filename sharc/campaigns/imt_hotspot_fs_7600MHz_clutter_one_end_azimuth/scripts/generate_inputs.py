...
input_file = base_dir / "imt_hotspot_fs_7600MHz_clutter_one_end/scripts/parameters_reference.yaml"
output_dir = base_dir / "imt_hotspot_fs_7600MHz_clutter_one_end/input"
...
for dista in [-2600, -6600, -11600, -16600, -21600]:
    for link_type in ["dl", "ul"]:
        ...
        modified_text[23] = f"    output_dir: {'campaigns/imt_hotspot_fs_7600MHz_clutter_one_end/output_dl/\n' if link_type == 'dl' else 'campaigns/imt_hotspot_fs_7600MHz/output_ul/\n'}"
        modified_text[26] = f"    output_dir_prefix: output_imt_hotspot_fs_7600MHz_clutter_one_end_{link_type}_{dista}m\n"
