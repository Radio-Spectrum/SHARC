...
input_file = base_dir / "imt_hotspot_fs_7600MHz_clutter_both_ends_azimuth/scripts/parameters_reference.yaml"
output_dir = base_dir / "imt_hotspot_fs_7600MHz_clutter_both_ends_azimuth/input"
