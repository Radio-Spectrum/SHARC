...
post_processor\
    .add_plot_legend_pattern(
        dir_name_contains="FS_1",
        legend="DL 0"
    ).add_plot_legend_pattern(
        dir_name_contains="FS_2",
        legend="DL 15 " 
    ).add_plot_legend_pattern(
        dir_name_contains="FS_3",
        legend="DL 30 "
    ).add_plot_legend_pattern(
        dir_name_contains="FS_4",
        legend="DL 45 "
    ).add_plot_legend_pattern(
        dir_name_contains="FS_5",
        legend="DL 60 "
    ).add_plot_legend_pattern(
        dir_name_contains="FS_UP_1",
        legend="UL 0"
    ).add_plot_legend_pattern(
        dir_name_contains="FS_UP_2",
        legend="UL 15 " 
    ).add_plot_legend_pattern(
        dir_name_contains="FS_UP_3",
        legend="UL 30 "
    ).add_plot_legend_pattern(
        dir_name_contains="FS_UP_4",
        legend="UL 45 "
    ).add_plot_legend_pattern(
        dir_name_contains="FS_UP_5",
        legend="UL 60 "
    )
