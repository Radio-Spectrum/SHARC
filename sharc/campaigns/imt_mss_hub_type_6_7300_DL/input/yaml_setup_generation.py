...
general:
  ...
  output_dir: campaigns/imt_mss_hub_type_6_7300_DL/output/   # Output directory (relative to the SHARC/sharc folder)
  output_dir_prefix: output_imt_mss_hub_type_6_DL_7300_y_{y}_load_probability_{load_probability_per} # Output directory prefix
imt:
  topology:
