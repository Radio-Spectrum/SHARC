...
class SimulationDownlinkHapsTest(unittest.TestCase):
    def setUp(self):
        ...
        self.param.haps.tx_power_density = (
            self.param.haps.eirp_density - self.param.haps.antenna_gain - 60
        )
    ...
    def test_simulation_2bs_4ue_1haps(self):
        ...
        self.simulation.propagation_system = PropagationFactory.create_propagation(
            self.param.haps.channel_model, self.param, random_number_gen
        )
