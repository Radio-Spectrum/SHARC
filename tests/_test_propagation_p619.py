...
class TestPropagationP619(unittest.TestCase):
    ...
    def test_atmospheric_gasses_loss(self):
        ...
        vapour_density_vec = [7.5, 12.5, 2.5, 5.0]
        apparent_elevation_vec = [0, 10, 20, 40]

        loss_lower_vec = [10, 1, 0.3, 0.2]
        loss_upper_vec = [20, 2, 0.4, 0.3]

        for vapour_density, apparent_elevation, loss_lower, loss_upper in zip(
            vapour_density_vec, apparent_elevation_vec, loss_lower_vec, loss_upper_vec
        ):
    ...
    def test_beam_spreading_attenuation(self):
        ...
        elevation_vec = [0, 0.5, 1, 2, 3, 5]
        att_lower_vec = [0.8, 0.6, 0.4, 0.2, 0.1, 0.05]
        att_upper_vec = [0.9, 0.7, 0.5, 0.3, 0.2, 0.1]
