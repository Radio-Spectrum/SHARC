...
class PostProcessor:
    ...
    RESULT_FIELDNAME_TO_PLOT_INFO = {
        ...
        "imt_bs_antenna_gain": IGNORE_FIELD,
        "imt_ue_antenna_gain": IGNORE_FIELD,
        "system_imt_antenna_gain": IGNORE_FIELD,
        "imt_system_antenna_gain": IGNORE_FIELD,
        "imt_ul_sinr": IGNORE_FIELD,
        "imt_dl_sinr": IGNORE_FIELD,
        "imt_ul_snr": IGNORE_FIELD,
        "imt_dl_snr": IGNORE_FIELD,
        "imt_ul_tput": IGNORE_FIELD,
        "imt_dl_tput": IGNORE_FIELD,
        "imt_dl_tx_power": IGNORE_FIELD,
        "system_dl_interf_power": IGNORE_FIELD,
        "system_ul_interf_power": IGNORE_FIELD,
        "imt_ul_tx_power_density": IGNORE_FIELD,
        "imt_ul_tx_power": IGNORE_FIELD,
        "imt_path_loss": IGNORE_FIELD,
        "imt_coupling_loss": IGNORE_FIELD
    }
