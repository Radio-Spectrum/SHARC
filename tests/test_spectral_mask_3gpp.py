...
class SpectalMask3GppTest(unittest.TestCase):
    ...
    def test_power_calc_ue(self):
        ...
        self.assertAlmostEqual(
            ...
            10
            * np.log10(
                np.power(10, 0.1 * (-21 + 10 * np.log10(1 / 0.03)))
                + np.power(10, 0.1 * (-10 + 10 * np.log10(4)))
            ),
            delta=1e-2,
        )
        ...
        bandwidth = 10
        poob = self.mask_ue.power_calc(fc, bandwidth)
        self.assertAlmostEqual(poob, -13 + 10 * np.log10(10), delta=1e-2)
        ...
        self.assertAlmostEqual(
            ...
            10
            * np.log10(
                np.power(10, 0.1 * (-13 + 10 * np.log10(5)))
                + np.power(10, 0.1 * (-25 + 10 * np.log10(5)))
            ),
            delta=1e-2,
        )
        ...
        self.assertAlmostEqual(
            ...
            * np.log10(
                np.power(10, 0.1 * (-25 + 10 * np.log10(5)))
                + np.power(10, 0.1 * (-30 + 10 * np.log10(5)))
            ),
            delta=1e-2,
        )
        ...
        bandwidth = 50
        poob = self.mask_ue.power_calc(fc, bandwidth)
        self.assertAlmostEqual(poob, -30 + 10 * np.log10(50), delta=1e-2)
