...
input_file = base_dir / "FS_example/scripts/FS_1.yaml"
output_dir = base_dir / "FS_example/input"
...
for dista in [-6600, -16600, -26600, -41600]:
    for link_type in ["dl", "ul"]:
        ...
        modified_text[23] = f"    output_dir: campaigns/FS_example/output\n"
        modified_text[26] = f"    output_dir_prefix: output_imt_macro_FS_example_{link_type}_{dista}m\n"
        
        # Alterar linha 324 para o ângulo de azimute correto
        modified_text[334] = f"    x: {dista}\n"
        
        # Criar nome do arquivo de saída
        output_filename = f"parameters_imt_imt_macro_FS_example_{link_type}_{dista}m.yaml"
