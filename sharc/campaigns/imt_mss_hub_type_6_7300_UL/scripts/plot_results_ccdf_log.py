...
output_filename = "CCDF_plot_MACRO"  # Nome base do arquivo de saída (sem extensão)
SAVE_FIG = True  # Defina como True para salvar a figura, ou False para exibir no navegador
OUTPUT_DIR = "/home/araujo/Documentos/Git/Projetos/Anatel/Graficos/MACRO_UL"  # Pasta onde os gráficos serão salvos
