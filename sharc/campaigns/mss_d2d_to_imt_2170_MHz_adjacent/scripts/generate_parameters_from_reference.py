...
for dist in [
    ...
    ul_parameter_file_name = os.path.join(
        input_dir, f"./parameters_mss_d2d_to_imt_2170MHz_adjacent_{dist}km_base_ul.yaml")
    dl_parameter_file_name = os.path.join(
        input_dir, f"./parameters_mss_d2d_to_imt_2170MHz_adjacent_{dist}km_base_dl.yaml")
