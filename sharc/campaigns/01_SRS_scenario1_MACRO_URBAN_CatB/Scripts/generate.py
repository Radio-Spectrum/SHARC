...
input_file = base_dir / "01_SRS_scenario1_MACRO_URBAN_CatB/scripts/SRS_1.yaml"
output_dir = base_dir / "01_SRS_scenario1_MACRO_URBAN_CatB/input"
...
for dista in [-2600, -6600, -11600, -16600, -21600]:
    for link_type in ["dl", "ul"]:
        ...
        modified_text[22] = f"    output_dir: campaigns/01_SRS_scenario1_MACRO_URBAN_CatB/output"
        modified_text[25] = f"    output_dir_prefix: output_01_SRS_scenario1_MACRO_URBAN_CatB_{link_type}_{dista}m\n"
        if link_type == 'dl':
            modified_text[346] = f"      Hte: 18\n"
        else:
            modified_text[346] = f"      Hte: 1.5\n"
        # Alterar linha 324 para o ângulo de azimute correto
        modified_text[363] = f"        x: {dista}\n"
        
        # Criar nome do arquivo de saída
        output_filename = f"parameters_01_SRS_scenario1_MACRO_URBAN_CatB_{link_type}_{dista}m.yaml"
