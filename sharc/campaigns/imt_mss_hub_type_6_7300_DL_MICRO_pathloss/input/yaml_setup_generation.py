...
general:
  ...
  output_dir: campaigns/imt_mss_hub_type_6_7300_DL_MICRO_pathloss/output/   # Output directory (relative to the SHARC/sharc folder)
  output_dir_prefix: output_imt_mss_hub_type_6_7300_DL_MICRO_pathloss_y_{y}_load_probability_{load_probability_per} # Output directory prefix
imt:
  topology:
    ...
    hotspot:
      ...
      num_hotspots_per_cell: 3                    # Number of hotspots per macro cell (sector)
...
single_earth_station:
  ...
  param_p425:
    ...
    Hte: 6                                  # Effective height of interfering antenna
