...
general:
  ...
  output_dir: campaigns/imt_mss_hub_type_6_7300_UL_MICRO/output/   # Output directory (relative to the SHARC/sharc folder)
  output_dir_prefix: output_imt_mss_hub_type_6_7300_UL_MICRO_y_{y}_load_probability_{load_probability_per} # Output directory prefix
imt:
  topology:
    ...
    hotspot:
      ...
      num_hotspots_per_cell: 1                    # Number of hotspots per macro cell (sector)
      max_dist_hotspot_ue: 400                   # Maximum 2D distance between hotspot and UE [m]
  ...
  ue:
    ...
    distribution_type: ANGLE_AND_DISTANCE                    # UE distribution type: UNIFORM or ANGLE_AND_DISTANCE
...
single_earth_station:
  ...
  geometry:
    ...
    elevation:
      type: FIXED
      fixed: 30                             # Placeholder for elevation value
    location:
      type: FIXED
      fixed:
        x: 0
