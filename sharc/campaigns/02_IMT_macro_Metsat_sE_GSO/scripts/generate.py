...
for sistema in ["Sat_Q", "Sat_P"]:
    ...
    modified_text[102 - 1] = f"      diameter: {'5' if sistema == "Sat_Q" else '3'}\n"
    ...
    for imt_cell in ["micro"]:
        ...
        modified_text[137 - 1] = f"    Hte: {'16' if imt_cell == "macro" else '8'}\n"
        ...
        for p_percentage in [20]: ##[20, 'RANDOM', 'RANDOM_CENARIO']
